    ...
    fetch(urlScanDetail.concat(urlAddition).concat("&scanDate=" + tempScanDateTime)).then(
        function (response) {
          ...
          response.json().then(function (data) {
            ...
            if (data[0].hasOwnProperty('ip')) {
              tempCell.innerHTML += "<span class='fontcolor'>" + "IP : " + "</span>" + data[0].ip + '<br>';
            } else {
              tempCell.innerHTML += "<span class='fontcolor'>" + "IP : " + "</span>" + "n.a." + "<br>";
            }

            if (data[0].hasOwnProperty('redirectType')) {
              tempCell.innerHTML += "<span class='fontcolor'>" + "Redirect Type : " + "</span>" + data[0].redirectType + '<br>';
            } else {
              tempCell.innerHTML += "<span class='fontcolor'>" + "Redirect Type : " + "</span>" + "n.a." + "<br>";
            }

            if (data[0].hasOwnProperty('formFields')) {
              // split result to make line break possible
              var tempSplittable = data[0].formFields;
            ...
            if (data[0].hasOwnProperty('certData')) {
              if (data[0].certData.hasOwnProperty('notValidBefore')) {
                tempCell.innerHTML += "<span class='fontcolor'>" + "Cert Issued : " + "</span>" + data[0].certData.notValidBefore + '<br>';
              } else {
            ...
            if (data[0].hasOwnProperty('certData')) {
              if (data[0].certData.hasOwnProperty('notValidAfter')) {
                tempCell.innerHTML += "<span class='fontcolor'>" + "Cert Expiry : " + "</span>" + data[0].certData.notValidAfter + '<br>';
              } else {
            ...
            if (data[0].hasOwnProperty('TLSServerInfo')) {
              if (data[0].TLSServerInfo.hasOwnProperty('highestTLSVersionSupported')) {
                tempCell.innerHTML += "<span class='fontcolor'>" + "TLS Version : " + "</span>" + data[0].TLSServerInfo.highestTLSVersionSupported + '<br>';
              } else {
            ...
            if (data[0].hasOwnProperty('certData')) {
              if (data[0].certData.hasOwnProperty('serialNumber')) {
                tempCell.innerHTML += "<span class='fontcolor'>" + "Serial : " + "</span>" + data[0].certData.serialNumber + '<br>';
              } else {
